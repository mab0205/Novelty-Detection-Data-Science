...
def len_words_distribution(df_source, df_target ):
    ...
    plt.title('Source and Target, Lenght Word Distribution')
...
def count_sentences_distribution(df_source, df_target ):
    ...
    plt.title('Source and Target Lenght, Sentences Distribution')
...
def publisher_distribution(df_news):
    ...
    plt.title('Source and Target, Publisher Distribution ')
